...
<body>
	<div id="top">
		<div id="topnavi">
			<a href="#">Hi~ <%=session.getAttribute("customerName")%></a>
		</div>
		<div id="toplogo"></div>
		<div id="navi">
			<div id="navitag">
	...
	<div id="index_main">
		...
		<div id="index_book">
			<div id="index_bookimage">
				<a href="bookDetailsServlet?bookId=<%=book.getBookId()%>&customername=<%=session.getAttribute("customerName")%>"
					target="_blank"><img alt="<%=book.getBookName()%>"
					src="images/<%=book.getBookImage()%>"> </a>
			</div>
			<div id="index_bookinfo">
				书&nbsp;&nbsp;名：《<%=book.getBookName()%>》<br> <br>
				作&nbsp;&nbsp;者：<%=book.getBookAuthor()%><br> <br> 出版社：<%=book.getBookPublisher()%><br>
				<br> 价&nbsp;&nbsp;格：<%=book.getBookPrice()%><br>
			</div>
		</div>
		<%
			}
